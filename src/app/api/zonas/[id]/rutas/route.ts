...
export async function GET(
    ...
    const url = `${TM_API_BASE}?lServicio=Rutas&lTipo=api&lFuncion=searchRutaByTipo&tipo_ruta=8&zona=${encodeURIComponent(id)}`;
    ...
    try {
        ...
        console.error('Error fetching rutas by zona:', error);
